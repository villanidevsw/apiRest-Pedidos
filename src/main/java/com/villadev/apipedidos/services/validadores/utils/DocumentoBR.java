package com.villadev.apipedidos.services.validadores.utils;
...
public class DocumentoBR {
  ...
  * @return
  */
 public static boolean ehValidoCPF(final String ssn) {
  ...
  * @return
  */
 public static boolean ehValidoCNPJ(final String tin) {
